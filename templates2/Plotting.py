...
# Considering weighted models.
    ...
    def plot_posterior_models1d(self, final=True, chainidx=0, depint=0.005):
    ...
    def plot_posterior_models2d(self, final=True, chainidx=0, depint=0.005):
        if final:
            nchains = self.initparams['nchains'] - self.outliers.size
        else:
            nchains = 1
...
# Plot current models and data fits. also plot best data fit incl. model.
    ...
    def save_chainplots(self, cidx=0, refmodel=dict(), depint=0.005):
        """
    ...
    def save_plots(self, nchains=5, refmodel=dict(), depint=0.005):
        """
        Refmodel is a dictionary and must contain plottable values:
